                        ...
                        sshPublisher(
                            publishers: [
                                sshPublisherDesc(
                                    ...
                                    transfers: [
                                        sshTransfer(
                                            execCommand: 'git clone https://github.com/Rivaldi-Idris-Junior-IT/pos-backend-frontend-cicd-jenkins-docker.git; cd pos-backend-frontend-cicd-jenkins-docker && docker-compose up -d; docker ps',
                                            execTimeout: 250000,
                                        )
                                    ]
                                )
